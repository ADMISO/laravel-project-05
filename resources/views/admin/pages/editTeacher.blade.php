            ...
            <div class=" col-md-6 d-flex  align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                @endif
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Edit Teacher Account</h5>
                    <p class="text-center small">Edit teacher information</p>
                  </div>

                  <form method="post" action="{{ url('admin/update-teacher/'.$u->id) }}" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
