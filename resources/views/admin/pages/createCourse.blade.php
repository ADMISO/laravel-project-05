            ...
            <div class=" col-md-6 d-flex  align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                @endif
                  ...
                  <form method="post" action="{{ url('admin/store-course') }}" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                      <label for="yourName" class="form-label">Course Code</label>
                      <input type="text" name="code" class="form-control" id="yourName" required>
